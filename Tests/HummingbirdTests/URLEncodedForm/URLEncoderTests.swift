    ...
    struct EncoderTests {
        ...
        func testForm(
            ...
            #expect(throws: Never.self) {
                ...
                Self.expectEncodedEqual(query2, query, sourceLocation: .init(fileID: fileID, filePath: filePath, line: line, column: column))
            }
        }
        ...
        @Test func testStringSpecialCharactersEncode() {
            struct Test: Codable {
                let a: String
            }
        ...
        @Test func testURLEncode() throws {
